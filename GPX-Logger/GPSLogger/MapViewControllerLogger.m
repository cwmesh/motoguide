...
@interface MapViewControllerLogger ()
...
@interface MapViewControllerLogger (CLLocationManagerDelegate) <CLLocationManagerDelegate>
@end

@interface MapViewControllerLogger (MKMapViewDelegate) <MKMapViewDelegate>
- (void)updateOverlay;
@end

@interface MapViewControllerLogger (UIActionSheetDelegate) <UIActionSheetDelegate>
...
@interface MapViewControllerLogger (MFMailComposeViewControllerDelegate) <MFMailComposeViewControllerDelegate>
@end



@implementation MapViewControllerLogger
...
#pragma mark -
@implementation MapViewControllerLogger (CLLocationManagerDelegate)
...
#pragma mark -
@implementation MapViewControllerLogger (MKMapViewDelegate)
...
#pragma mark -
@implementation MapViewControllerLogger (UIActionSheetDelegate)
...
#pragma mark -
@implementation MapViewControllerLogger (MFMailComposeViewControllerDelegate)
